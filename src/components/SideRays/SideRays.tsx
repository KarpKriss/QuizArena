/*
 * SideRays background adapted from the React Bits component supplied for Quiz Arena.
 * Uses OGL/WebGL and pauses itself when outside the viewport.
 */
...
type UniformValue = number | number[] | RGB
interface Uniform { value: UniformValue }
    ...
    const initializeWebGL = async () => {
      ...
      cleanupFunctionRef.current = () => {
        ...
        try {
          ...
          // WebGL context may already be gone during unmount.
        }
